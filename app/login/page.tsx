  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-full max-w-sm text-center">
        <div className="mx-auto h-12 w-12 bg-gray-900 rounded-xl flex items-center justify-center mb-6">
          <span className="text-white font-bold text-lg">CR</span>
        </div>
        <h1 className="text-2xl font-bold text-gray-900 mb-2">CSM Hub</h1>
        <p className="text-gray-500 text-sm mb-8">
          Enterprise customer call dashboard for the CodeRabbit CSM team.
        </p>
        <button
        ...
        <p className="text-xs text-gray-400 mt-6">
          Access restricted to @coderabbit.ai accounts.
        </p>
      </div>
    </div>
  );
